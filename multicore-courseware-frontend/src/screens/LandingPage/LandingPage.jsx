  ...
  return (
    <div className=" relative mb-10 flex flex-col  justify-center  items-center">
      ...
      <div className="  text-black py-20 ">
        <motion.div className="container mx-auto flex flex-col items-center">
          <motion.h1
      ...
      <div className=" w-[100%]">
        <Carousel fade className=" mb-12 mt-3">
          <Carousel.Item>
            <img
          ...
          <Carousel.Item>
            <img
              className="d-block w-100 h-[600px] object-center content-center"
          ...
          <Carousel.Item>
            <img
              className="d-block w-100 h-[600px] "
            ...
            <Carousel.Caption className=" bg-gray-500  bg-opacity-75">
              ...
              <p>
                ...
                simulations, mastering parallel thinking skills for success.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      ...
      >
        <h2 className=" font-bold text-center text-3xl">Courses</h2>
